package com.jonas.steamlite.controller.authenticationfilter;
...
import com.jonas.steamlite.model.bean.UserHandler;
...
//			res.sendRedirect(req.getContextPath()+req.get);
			...
			System.out.println(req.getContextPath()+"/login.xhtml");
